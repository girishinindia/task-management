...
const ACTION_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "task.comment_added", label: "Comment added" },
  { value: "task.comment_deleted", label: "Comment deleted" },
  { value: "task.bulk_action", label: "Bulk action" },
  { value: "task.recurrence_regenerated", label: "Recurrence regenerated" },
  ...
  { value: "admin.password_set", label: "Temporary password set" },
  ...
  { value: "project.requested", label: "Project requested" },
];
