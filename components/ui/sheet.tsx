...
/**
 * Sheet — a side-anchored Dialog (right side by default).
 *
 * Uses the same Radix Dialog primitive as components/ui/dialog.tsx, but renders
 * the content as a panel sliding in from the edge. Light theme; mirrors the
 * shadcn/ui look.
 */
